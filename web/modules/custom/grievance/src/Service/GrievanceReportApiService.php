...
namespace Drupal\grievance\Service;

use GuzzleHttp\ClientInterface;
use Drupal\global_module\Service\GlobalVariablesService;

class GrievanceReportApiService
{
    ...
    // public function sendGrievanceAsync(array $data)
    // {
    //     $checksum = $this->generateChecksum($data);
    //     $csrf_token = $this->getCsrfToken();
    ...
    //     $grievanceUrl = $globalVariables['apiManConfig']['config']['apiUrl'] .
    //         'trinityengage-casemanagementsystem' .
    //         $globalVariables['apiManConfig']['config']['apiVersion'] .
    //         'grievance-manage/report-grievance';
    ...
    //     // Fire async request
    //     $promise = $this->httpClient->requestAsync('POST', $grievanceUrl, $options);
    ...
    //                 'Async grievance submitted for userId @uid: @response',
    ...
    //     // Return the promise, so caller can choose to wait or not
    //     return $promise;
    // }
