...
class ReportGrievanceFormTest extends UnitTestCase {
  ...
  public function testValidateForm() {
    ...
    $cache_bin = $this->createMock(CacheBackendInterface::class);
    $cache_bin->method('get')->willReturnMap([
      ['grievance_types', $cache_obj],
      ['grievance_subtypes_1', $sub_cache_obj],
    ]);
    
    $container = \Drupal::getContainer();
    $container->set('cache.default', $cache_bin);
  ...
  public function testSubmitFormSuccess() {
    ...
    $session->method('get')->with('api_redirect_result')->willReturn(['userId' => 123]);
